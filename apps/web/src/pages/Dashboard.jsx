  ...
  return (
    <div>
      ...
      <div className="grid-detail">
        ...
        <div className="card">
          <div className="card-header">
            <h3 className="text-lg font-semibold text-primary">最近活动</h3>
          </div>
          <div className="card-body">
            <div className="space-y-3">
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="flex items-center gap-3 p-2 rounded hoverable">
                  <div className="w-2 h-2 bg-success rounded-full"></div>
                  <div className="flex-1">
                    <p className="text-sm text-primary">Agent-{item} 执行任务成功</p>
                    <p className="text-xs text-muted">2分钟前</p>
                  </div>
                </div>
              ))}
            </div>
